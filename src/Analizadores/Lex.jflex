...
<YYINITIAL> {COMILLA}           {  System.out.println(yytext()+" //COMILLA"); return new Symbol(sym.COMILLA, yyline, yycolumn,yytext());  }
...
<YYINITIAL> {GUION}             {  System.out.println(yytext()+" //GUION"); return new Symbol(sym.GUION, yyline, yycolumn,yytext());  }
<YYINITIAL> {MAYOR}             {  System.out.println(yytext()+" //MAYOR"); return new Symbol(sym.MAYOR, yyline, yycolumn,yytext());  }
